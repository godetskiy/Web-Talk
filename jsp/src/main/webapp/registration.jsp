...
<head>
    ...
    <script type="text/javascript">
        function validate(){
            ...
            if (name.length == 0) {
                document.getElementById("name").innerHTML = "* Имя пользователя обязательно";
                e = false;
            }
            return e;
        }
...
<form name="form" method="post" action="registration" onsubmit="return validate(); ">
    <center>
        <table>
            ...
            <tr>
                ...
                <td><input type="text" maxlength="49" name="name"></td>
            </tr>
            ...
            <tr align="center" >
                <td colspan="2"><input type="submit" value="Регистрация" >
